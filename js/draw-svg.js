function drawRooms() {
    ...
    var background = draw.rect(width, height).attr({ fill: 'rgb(71, 69, 66)' });
      ...
      d002.attr({
          fill: 'green', 'fill-opacity': 1,stroke: '#000', 'stroke-width': 1
        });
      var d003 = draw.polygon([ [270, 30], [385, 30], [385, 150], [270, 150] ]);
      d003.attr({
        fill: '#FFFF66', 'fill-opacity': 1,stroke: '#000', 'stroke-width': 1
      });
      ...
      d007.attr({
        fill: 'grey', 'fill-opacity': 1,stroke: '#000', 'stroke-width': 1
      });
