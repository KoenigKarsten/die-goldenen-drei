...
! function(t, e) {
    ...
    function d(t) {
        return t = t.replace(y.regex.whitespace, "").replace(y.regex.matrix, "").split(y.regex.matrixElements), l(y.utils.map(t, function(t) {
            return parseFloat(t)
        }))
    }
    ...
    var y = this.SVG = function(t) {
        if (y.supported) return t = new y.Doc(t), y.parser.draw || y.prepare(), t
    };
    ...
    y.did = 1e3, y.eid = function(t) {
        ...
        var t = e.getElementsByTagName("body")[0],
            i = (t ? new y.Doc(t) : new y.Doc(e.documentElement).nested()).size(2, 0);
        y.parser = {
        ...
        var e;
        this.r = 0, this.g = 0, this.b = 0, t && ("string" == typeof t ? y.regex.isRgb.test(t) ? (e = y.regex.rgb.exec(t.replace(/\s/g, "")), this.r = parseInt(e[1]), this.g = parseInt(e[2]), this.b = parseInt(e[3])) : y.regex.isHex.test(t) && (e = y.regex.hex.exec(a(t)), this.r = parseInt(e[1], 16), this.g = parseInt(e[2], 16), this.b = parseInt(e[3], 16)) : "object" == typeof t && (this.r = t.r, this.g = t.g, this.b = t.b))
    }, y.extend(y.Color, {
        toString: function() {
            return this.toHex()
        },
        ...
        at: function(t) {
            return this.destination ? (t = t < 0 ? 0 : t > 1 ? 1 : t, new y.Color({
        ...
        at: function(t) {
            ...
            return new y.PointArray(n)
        },
        parse: function(t) {
            var e = [];
            if (t = t.valueOf(), Array.isArray(t)) return t;
            t = t.trim().split(/\s+|,/), t.length % 2 !== 0 && t.pop();
            for (var i = 0, n = t.length; i < n; i += 2) e.push([parseFloat(t[i]), parseFloat(t[i + 1])]);
            return e
        },
        move: function(t, e) {
            var i = this.bbox();
        ...
        parse: function(t) {
            ...
            var a = [];
            do {
                for (y.regex.isPathLetter.test(t[0]) ? (r = t[0], t.shift()) : "M" == r ? r = "L" : "m" == r && (r = "l"), s = [r.toUpperCase()], e = 0; e < u[s[0]]; ++e) s.push(parseFloat(t.shift()));
        ...
        create: function(t, e) {
            this.value = 0, this.unit = e || "", "number" == typeof t ? this.value = isNaN(t) ? 0 : isFinite(t) ? t : t < 0 ? -3.4e38 : 3.4e38 : "string" == typeof t ? (e = t.match(y.regex.numberAndUnit), e && (this.value = parseFloat(e[1]), "%" == e[5] ? this.value /= 100 : "s" == e[5] && (this.value *= 1e3), this.unit = e[5])) : t instanceof y.Number && (this.value = t.valueOf(), this.unit = t.unit)
        },
        extend: {
            toString: function() {
        ...
        extend: {
            ...
            size: function(t, e) {
                var i = h(this, t, e);
                return this.width(new y.Number(i.width)).height(new y.Number(i.height))
            },
            clone: function(t) {
            ...
            parent: function(t) {
                ...
                if (e = y.adopt(e.node.parentNode), !t) return e;
            ...
            svg: function(t) {
                ...
                if (!(t && this instanceof y.Parent)) return i.appendChild(t = e.createElement("svg")), this.writeDataToDom(), t.appendChild(this.node.cloneNode(!0)), i.innerHTML.replace(/^<svg>/, "").replace(/<\/svg>$/, "");
        ...
        return function(e, i) {
            return new y.MorphObj(e, i).at(t)
        }
    }, y.Situation = y.invent({
        create: function(t) {
            this.init = !1, this.reversed = !1, this.reversing = !1, this.duration = new y.Number(t.duration).valueOf(), this.delay = new y.Number(t.delay).valueOf(), this.start = +new Date + this.delay, this.finish = this.start + this.duration, this.ease = t.ease, this.loop = !1, this.loops = !1, this.animations = {}, this.attrs = {}, this.styles = {}, this.transforms = [], this.once = {}
        }
    }), y.Delay = function(t) {
        this.delay = new y.Number(t).valueOf()
    }, y.FX = y.invent({
        create: function(t) {
            this._target = t, this.situations = [], this.active = !1, this.situation = null, this.paused = !1, this.lastPos = 0, this.pos = 0, this._speed = 1
        },
        extend: {
            animate: function(t, e, i) {
                "object" == typeof t && (e = t.ease, i = t.delay, t = t.duration);
                var n = new y.Situation({
                    duration: t || 1e3,
                    delay: i || 0,
                    ease: y.easing[e || "-"] || e
                });
            ...
            target: function(t) {
                return t && t instanceof y.Element ? (this._target = t, this) : this._target
            },
            ...
            start: function() {
                return !this.active && this.situation && (this.situation.start = +new Date + this.situation.delay, this.situation.finish = this.situation.start + this.situation.duration / this._speed, this.initAnimations(), this.active = !0, this.startAnimFrame()), this
            },
            queue: function(t) {
                return ("function" == typeof t || t instanceof y.Situation || t instanceof y.Delay) && this.situations.push(t), this.situation || (this.situation = this.situations.shift()), this
            },
            dequeue: function() {
                if (this.situation && this.situation.stop && this.situation.stop(), this.situation = this.situations.shift(), this.situation) {
                    var t = function() {
                        this.situation instanceof y.Situation ? this.initAnimations().at(0) : this.situation instanceof y.Delay ? this.dequeue() : this.situation.call(this)
                    }.bind(this);
            ...
            initAnimations: function() {
                ...
                for (t in e.attrs)
                    if (e.attrs[t] instanceof y.Color) {
                        var i = new y.Color(this.target().attr(t));
            ...
            at: function(t) {
                var e = this.situation.duration / this._speed;
                return this.pos = t, this.situation.start = +new Date - t * e, this.situation.finish = this.situation.start + e, this.step(!0)
            },
            speed: function(t) {
                return 0 === t ? this.pause() : t ? (this._speed = t, this.at(this.situation.reversed ? 1 - this.pos : this.pos)) : this._speed
            },
            loop: function(t, e) {
                var i = this.last();
                return i.loop = i.loops = t || !0, e && (i.reversing = !0), this
            },
            pause: function() {
            ...
            during: function(t) {
                var e = this.last(),
                    i = function(i) {
                        i.detail.situation == e && t.call(this, i.detail.pos, y.morph(i.detail.pos), i.detail.eased, e)
                    };
            ...
            duringAll: function(t) {
                var e = function(e) {
                    t.call(this, e.detail.pos, y.morph(e.detail.pos), e.detail.eased, e.detail.situation)
                };
            ...
            step: function(t) {
                ...
                for (var i in this.situation.once) i > this.lastPos && i <= e && (this.situation.once[i].call(this.target(), this.pos, e), delete this.situation.once[i]);
            ...
            eachAt: function() {
                ...
                if (r.transforms.length) {
                    ...
                    for (t in r.transforms) {
                        ...
                        s instanceof y.Matrix ? e = s.relative ? e.multiply(s.at(r.ease(this.pos))) : e.morph(s).at(r.ease(this.pos)) : (s.relative || s.undo(e.extract()), e = e.multiply(s.at(r.ease(this.pos))))
                    }
                    n.matrix(e)
                }
                return this
        ...
        construct: {
            animate: function(t, e, i) {
                return (this.fx || (this.fx = new y.FX(this))).animate(t, e, i)
            },
            delay: function(t) {
                return (this.fx || (this.fx = new y.FX(this))).delay(t)
            },
            stop: function(t, e) {
        ...
        create: function(t, e) {
            return y.Color.isColor(e) ? new y.Color(t).morph(e) : y.regex.numberAndUnit.test(e) ? new y.Number(t).morph(e) : (this.value = 0, void(this.destination = e))
        },
        extend: {
            at: function(t, e) {
        ...
        attr: function(t, e, i) {
            ...
            else this.add(t, new y.MorphObj(null, e), "attrs");
            return this
        },
        style: function(t, e) {
            if ("object" == typeof t)
                for (var i in t) this.style(i, t[i]);
            else this.add(t, new y.MorphObj(null, e), "styles");
            return this
        },
        x: function(t, e) {
            if (this.target() instanceof y.G) return this.transform({
                x: t
            }, e), this;
            var i = (new y.Number).morph(t);
        ...
        cx: function(t) {
            return this.add("cx", (new y.Number).morph(t))
        },
        cy: function(t) {
            return this.add("cy", (new y.Number).morph(t))
        },
        move: function(t, e) {
            return this.x(t).y(e)
        },
        ...
        size: function(t, e) {
            if (this.target() instanceof y.Text) this.attr("font-size", t);
                ...
                var i;
                t && e || (i = this.target().bbox()), t || (t = i.width / i.height * e), e || (e = i.height / i.width * t), this.add("width", (new y.Number).morph(t)).add("height", (new y.Number).morph(e))
            }
            return this
        },
        plot: function(t) {
        ...
        leading: function(t) {
            return this.target().leading ? this.add("leading", (new y.Number).morph(t)) : this
        },
        viewbox: function(t, e, i, n) {
            return this.target() instanceof y.Container && this.add("viewbox", new y.ViewBox(t, e, i, n)), this
        },
        update: function(t) {
            if (this.target() instanceof y.Stop) {
                if ("number" == typeof t || t instanceof y.Number) return this.update({
                    offset: arguments[0],
                    color: arguments[1],
                    opacity: arguments[2]
                });
            ...
            if (t) {
                ...
                try {
                    ...
                    if (t instanceof y.Shape) {
                        var n = t.clone(y.parser.draw).show();
                        i = n.bbox(), n.remove()
                    } else i = {
                        x: t.node.clientLeft,
                        y: t.node.clientTop,
        ...
        create: function(t) {
            ...
            for (t = t instanceof y.Element ? t.matrixify() : "string" == typeof t ? d(t) : 6 == arguments.length ? l([].slice.call(arguments)) : "object" == typeof t ? t : i, e = w.length - 1; e >= 0; --e) this[w[e]] = t && "number" == typeof t[w[e]] ? t[w[e]] : i[w[e]]
        },
        extend: {
            extract: function() {
                var t = u(this, 0, 1),
            ...
            multiply: function(t) {
                return new y.Matrix(this.native().multiply(c(t).native()))
            },
            inverse: function() {
            ...
            scale: function(t, e, i, n) {
                return 1 != arguments.length && 3 != arguments.length || (e = t), 3 == arguments.length && (n = i, i = e), this.around(i, n, new y.Matrix(t, 0, 0, e, 0, 0))
            },
            rotate: function(t, e, i) {
                return t = y.utils.radians(t), this.around(e, i, new y.Matrix(Math.cos(t), Math.sin(t), (-Math.sin(t)), Math.cos(t), 0, 0))
            },
            flip: function(t, e) {
            ...
            around: function(t, e, i) {
                return this.multiply(new y.Matrix(1, 0, 0, 1, t || 0, e || 0)).multiply(i).multiply(new y.Matrix(1, 0, 0, 1, -t || 0, -e || 0))
            },
            native: function() {
                for (var t = y.parser.native.createSVGMatrix(), e = w.length - 1; e >= 0; e--) t[w[e]] = this[w[e]];
                return t
            },
            toString: function() {
        ...
        extend: {
            ...
            native: function() {
                var t = y.parser.native.createSVGPoint();
        ...
        attr: function(t, e, i) {
            if (null == t) {
                for (t = {}, e = this.node.attributes, i = e.length - 1; i >= 0; i--) t[e[i].nodeName] = y.regex.isNumber.test(e[i].nodeValue) ? parseFloat(e[i].nodeValue) : e[i].nodeValue;
                return t
            }
            if ("object" == typeof t)
        ...
        transform: function(t, e) {
            var i, n = this;
            if ("object" != typeof t) return i = new y.Matrix(n).extract(), "string" == typeof t ? i[t] : i;
            if (i = new y.Matrix(n), e = !!e || !!t.relative, null != t.a) i = e ? i.multiply(new y.Matrix(t)) : new y.Matrix(t);
            else if (null != t.rotation) f(t, n), i = e ? i.rotate(t.rotation, t.cx, t.cy) : i.rotate(t.rotation - i.extract().rotation, t.cx, t.cy);
                ...
                if (f(t, n), t.skewX = null != t.skewX ? t.skewX : 0, t.skewY = null != t.skewY ? t.skewY : 0, !e) {
                    var r = i.extract();
                    i = i.multiply((new y.Matrix).skew(r.skewX, r.skewY, t.cx, t.cy).inverse())
                }
        ...
        extend: {
            at: function(t) {
                ...
                var r = this._undo || new y.Matrix;
                return r = (new y.Matrix).morph(y.Matrix.prototype[this.method].apply(r, e)).at(t), this.inversed ? r.inverse() : r
            },
            undo: function(t) {
                for (var e = 0, i = this.arguments.length; e < i; ++e) t[this.arguments[e]] = "undefined" == typeof this[this.arguments[e]] ? 0 : t[this.arguments[e]];
                return this._undo = new(y[s(this.method)])(t, (!0)).at(1), this
            }
        }
    }), y.Translate = y.invent({
        parent: y.Matrix,
        inherit: y.Transformation,
        create: function(t, e) {
        ...
        extend: {
            ...
            method: "rotate",
            at: function(t) {
                var e = (new y.Matrix).rotate((new y.Number).morph(this.rotation - (this._undo ? this._undo.rotation : 0)).at(t), this.cx, this.cy);
        ...
        extend: {
            ...
            get: function(t) {
                return y.adopt(this.node.childNodes[t])
            },
            first: function() {
                return this.get(0)
            },
            ...
            each: function(t, e) {
                ...
                for (i = 0, n = r.length; i < n; i++) r[i] instanceof y.Element && t.apply(r[i], [i, r]), e && r[i] instanceof y.Container && r[i].each(t, e);
                return this
            },
        ...
        create: function(t) {
            var e, i, n, r, s, a, o, h, u = [0, 0, 0, 0],
                l = 1,
                c = 1,
                f = /[+-]?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?/gi;
            if (t instanceof y.Element) {
                for (o = t, h = t, a = (t.attr("viewBox") || "").match(f), s = t.bbox, n = new y.Number(t.width()), r = new y.Number(t.height());
                    "%" == n.unit;) l *= n.value, n = new y.Number(o instanceof y.Doc ? o.parent().offsetWidth : o.parent().width()), o = o.parent();
                for (;
                    "%" == r.unit;) c *= r.value, r = new y.Number(h instanceof y.Doc ? h.parent().offsetHeight : h.parent().height()), h = h.parent();
        ...
        extend: {
            ...
            morph: function(t) {
                ...
                return this.destination = new y.ViewBox(t), this
            },
            at: function(t) {
                return this.destination ? new y.ViewBox([this.x + (this.destination.x - this.x) * t, this.y + (this.destination.y - this.y) * t, this.width + (this.destination.width - this.width) * t, this.height + (this.destination.height - this.height) * t]) : this
            }
        },
        parent: y.Container,
        construct: {
    ...
    }), y.listeners = [], y.handlerMap = [], y.listenerId = 0, y.on = function(t, e, i, n) {
        var r = i.bind(n || t.instance || t),
            s = (y.handlerMap.indexOf(t) + 1 || y.handlerMap.push(t)) - 1,
            a = e.split(".")[0],
            o = e.split(".")[1] || "*";
        y.listeners[s] = y.listeners[s] || {}, y.listeners[s][a] = y.listeners[s][a] || {}, y.listeners[s][a][o] = y.listeners[s][a][o] || {}, i._svgjsListenerId || (i._svgjsListenerId = ++y.listenerId), y.listeners[s][a][o][i._svgjsListenerId] = r, t.addEventListener(a, r, !1)
    }, y.off = function(t, e, i) {
        var n = y.handlerMap.indexOf(t),
            r = e && e.split(".")[0],
            s = e && e.split(".")[1];
        if (n != -1)
            if (i) {
                if ("function" == typeof i && (i = i._svgjsListenerId), !i) return;
                y.listeners[n][r] && y.listeners[n][r][s || "*"] && (t.removeEventListener(r, y.listeners[n][r][s || "*"][i], !1), delete y.listeners[n][r][s || "*"][i])
            } else if (s && r) {
            if (y.listeners[n][r] && y.listeners[n][r][s]) {
                for (i in y.listeners[n][r][s]) y.off(t, [r, s].join("."), i);
                delete y.listeners[n][r][s]
            }
        } else if (s)
            for (e in y.listeners[n])
                for (namespace in y.listeners[n][e]) s === namespace && y.off(t, [e, s].join("."));
        else if (r) {
            if (y.listeners[n][r]) {
                for (namespace in y.listeners[n][r]) y.off(t, [r, namespace].join("."));
                delete y.listeners[n][r]
            }
        } else {
            for (e in y.listeners[n]) y.off(t, e);
            delete y.listeners[n]
        }
    }, y.extend(y.Element, {
        on: function(t, e, i) {
            return y.on(this.node, t, e, i), this
        },
        off: function(t, e) {
        ...
        extend: {
            at: function(t, e, i) {
                return this.put(new y.Stop).update(t, e, i)
            },
            update: function(t) {
            ...
            attr: function(t, e, i) {
                return "transform" == t && (t = "gradientTransform"), y.Container.prototype.attr.call(this, t, e, i)
            }
        },
        construct: {
        ...
        extend: {
            ...
            attr: function(t, e, i) {
                return "transform" == t && (t = "patternTransform"), y.Container.prototype.attr.call(this, t, e, i)
            }
        },
        construct: {
        ...
        pattern: function(t, e, i) {
            return this.put(new y.Pattern).update(i).attr({
                x: 0,
                y: 0,
                width: t,
                height: e,
        ...
        create: function(t) {
            t && (t = "string" == typeof t ? e.getElementById(t) : t, "svg" == t.nodeName ? this.constructor.call(this, t) : (this.constructor.call(this, y.create("svg")), t.appendChild(this.node), this.size("100%", "100%")), this.namespace().defs())
        },
        inherit: y.Container,
        extend: {
            namespace: function() {
        ...
        size: function(t, e) {
            var i = h(this, t, e);
            return this.rx(new y.Number(i.width).divide(2)).ry(new y.Number(i.height).divide(2))
        }
    }), y.Line = y.invent({
        create: "line",
        inherit: y.Shape,
        ...
        construct: {
            line: function(t, e, i, n) {
                return this.put(new y.Line).plot(t, e, i, n)
            }
        }
    }), y.Polyline = y.invent({
        create: "polyline",
        ...
        construct: {
            image: function(t, e, i) {
                return this.put(new y.Image).load(t).size(e || 0, i || e || 0)
            }
        }
    }), y.Text = y.invent({
        create: function() {
        ...
        extend: {
            ...
            text: function(t) {
                if ("undefined" == typeof t) {
                    for (var t = "", e = this.node.childNodes, i = 0, n = e.length; i < n; ++i) 0 != i && 3 != e[i].nodeType && 1 == y.adopt(e[i]).dom.newLined && (t += "\n"), t += e[i].textContent;
                    return t
                }
            ...
            lines: function() {
                var t = (this.textPath && this.textPath() || this).node,
                    e = y.utils.map(y.utils.filterSVGElements(t.childNodes), function(t) {
                        return y.adopt(t)
                    });
                return new y.Set(e)
            },
            rebuild: function(t) {
                if ("boolean" == typeof t && (this._rebuild = t), this._rebuild) {
                    var e = this,
                        i = 0,
                        n = this.dom.leading * new y.Number(this.attr("font-size"));
        ...
        construct: {
            path: function(t) {
                for (var e = new y.TextPath, i = this.doc().defs().path(t); this.node.hasChildNodes();) e.node.appendChild(this.node.firstChild);
                return this.node.appendChild(e.node), e.attr("href", "#" + i, y.xlink), this
            },
            plot: function(t) {
                var e = this.track();
            ...
            textPath: function() {
                if (this.node.firstChild && "textPath" == this.node.firstChild.nodeName) return y.adopt(this.node.firstChild)
            }
        }
    }), y.Nested = y.invent({
        create: function() {
        ...
        marker: function(t, e, i) {
            return this.put(new y.Marker).size(t, e).ref(t / 2, e / 2).viewbox(0, 0, t, e).attr("orient", "auto").update(i)
        }
    }), y.extend(y.Line, y.Polyline, y.Polygon, y.Path, {
        marker: function(t, e, i, n) {
            var r = ["marker"];
            return "all" != t && r.push(t), r = r.join("-"), t = arguments[1] instanceof y.Marker ? arguments[1] : this.doc().marker(e, i, n), this.attr(r, t)
        }
    });
    var g = {
    ...
    ["fill", "stroke"].forEach(function(t) {
        ...
        i[t] = function(i) {
            ...
            if ("string" == typeof i || y.Color.isRgb(i) || i && "function" == typeof i.fill) this.attr(t, i);
            else
                for (e = g[t].length - 1; e >= 0; e--) null != i[g[t][e]] && this.attr(g.prefix(t, g[t][e]), i[g[t][e]]);
            return this
        }, y.extend(y.Element, y.FX, i)
        ...
        dx: function(t) {
            return this.x((this instanceof y.FX ? 0 : this.x()) + t, !0)
        },
        dy: function(t) {
            return this.y((this instanceof y.FX ? 0 : this.y()) + t, !0)
        },
        dmove: function(t, e) {
        ...
        radius: function(t, e) {
            ...
            return "radial" == i || "circle" == i ? this.attr("r", new y.Number(t)) : this.rx(t).ry(null == e ? t : e)
        }
    }), y.extend(y.Path, {
        length: function() {
        ...
        return y.adopt(i)
    }, y.select = function(t, i) {
        return new y.Set(y.utils.map((i || e).querySelectorAll(t), function(t) {
            return y.adopt(t)
        }))
    }, y.extend(y.Parent, {
        select: function(t) {
